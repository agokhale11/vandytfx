...
urlpatterns = [
    ...
    url(r'^([a-zA-Z0-9_-]{3,16})/assign_comprehensive_teams/$', views.assign_comprehensive_teams_view, name='assign_teams'),
    url(r'^([a-zA-Z0-9_-]{3,16})/assign_representative_teams/$', views.assign_representative_teams_view, name='assign_teams'),
